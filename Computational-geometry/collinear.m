...
%   TF = true if the points P(i,:),  i=1,...,size(P,1) are collinear up to a 
%   given tolerance TOL. Works for any dimension (number of columns in P) and 
%   for any number of points (rows of P). If not given, TOL = 0.
%
%   Examples:
